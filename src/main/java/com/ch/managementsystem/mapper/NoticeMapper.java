...
import com.ch.managementsystem.entity.Notice; // 导入Notice实体类，表示数据库中的通知表
...
public interface NoticeMapper extends BaseMapper<Notice> {  // 定义NoticeMapper接口，继承BaseMapper接口
    // 继承自BaseMapper的通用方法：
