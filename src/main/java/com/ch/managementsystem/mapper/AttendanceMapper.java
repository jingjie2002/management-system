...
import com.ch.managementsystem.entity.Attendance; // 导入Attendance实体类，表示数据库中的考勤表
...
public interface AttendanceMapper extends BaseMapper<Attendance> { // 定义AttendanceMapper接口，继承BaseMapper接口
